<template>
	...
	<view :class="{'open':openDis}">
		<view class="uni-flex uni-column listWrap">
			<view class="uni-flex uni-row settingList">
				<view class="left" >手机号</view>
				<view class="right">
					<input type="number" :maxlength="12" @input="watchPhone" v-model="phoneNumber" placeholder-style="color:#a8a8a8"  placeholder="修改手机号" />
				</view>
			</view>
		</view>
		<view class="bottom" @click="openPhoneVerification">更换手机号</view>
	</view>
	</view>
</template>
	...
	export default {
		...
		methods: {
			...
			togglePopupOpen(type){
				this.type = type
				uni.redirectTo({
					url:'/pages/setting/landlord/phoneVerification'
				})
			},
			watchPhone(){
				...
				var reg = /^((13|14|15|17|18)[0-9]{1}\d{8})$/;
				 if(this.phoneNumber==''||this.phoneNumber==null){
					...
					return
					 ...
					 uni.redirectTo({
						url:'/pages/setting/landlord/phoneVerification?phoneNumber='+this.phoneNumber
					})
				}
