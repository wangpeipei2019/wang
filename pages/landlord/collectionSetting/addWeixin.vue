<template>
	<view v-if="isShow">
		<uni-nav-bar fixed="true" statusBar="true" left-icon="back" @click-left="comeBack()" title="添加微信"></uni-nav-bar>
		<view class="addRec">
			<view class="uni-flex uni-column addRedTop">
				<view class="uni-flex uni-column center">
					<view class="logImg"><image :src="imageUrl+'nav_logo_weixin.png'"></image></view>
					<view class="text">您需要填写有效的支付宝账号，以及真实的姓名</view>
				</view>
				<view class="uni-flex uni-row topList">
					<view class="left">微信账号</view>
					<view class="right">
						<input type="number"  placeholder-style="color:#50cde2;" placeholder ="输入微信账号"/>
					</view>
				</view>
				<view class="uni-flex uni-row topList">
					<view class="left">真实姓名</view>
					<view class="right">
						<input type="text"  placeholder-style="color:#50cde2;" placeholder ="请输入真实姓名"/>
					</view>
				</view>
			</view>
				...
				<view class="uni-flex uni-column">
					<radio-group class="uni-flex uni-column" @change="radioChange">
						<label class="uni-flex uni-row labelList">
							<view>
								<radio id="order" :color="radioColor" style="transform:scale(0.7)" value="order" checked="true"></radio>
							</view>
						...
						<label class="uni-flex uni-row labelList">
							<view>
								<radio id="date" :color="radioColor" style="transform:scale(0.7)" value="date" checked=""></radio>
							</view>
							<view class="borderBot">
								<label class="uni-flex uni-column labelText" >
									<text>按日结算</text>
...
<style scoped>
	...
	.labelList radio{
		...
		.determine{
			...
			line-height: 88upx;
			text-align: center;
			background: linear-gradient(to right, #65d8a8, #70efa1);
		}
</style>
