	...
	<view class="addRec" v-if="isShow">
		<view class="uni-flex uni-column addRedTop">
			<view class="uni-flex uni-column center">
				...
				<view class="text">您需要填写有效的微信账号，以及真实的姓名</view>
			</view>
			<view class="uni-flex uni-row topList">
				<view class="left">微信账号</view>
				<view class="right">
					<input type="number"  placeholder-style="color:#50cde2;" v-model="payAccount" placeholder ="输入微信账号"/>
				</view>
			</view>
			<view class="uni-flex uni-row topList">
				<view class="left">真实姓名</view>
				<view class="right">
					<input type="text"  placeholder-style="color:#50cde2;" v-model="payName" placeholder ="请输入真实姓名"/>
				</view>
			</view>
		</view>
			...
			<view class="uni-flex uni-column">
				<radio-group class="uni-flex uni-column" @change="radioChange">
					<label class="uni-flex uni-row labelList">
						<view>
							<radio color="#45c298" style="transform:scale(0.8)" id="order" value="1" :checked="current"></radio>
						</view>
					...
					<label class="uni-flex uni-row labelList">
						<view>
							<radio color="#45c298" style="transform:scale(0.8)" id="date" value="2" :checked="!current"></radio>
						</view>
						<view class="borderBot">
							<label class="uni-flex uni-column labelText" >
								<text>按日结算</text>
