<template>
	<view v-if="isShow">
		<uni-nav-bar fixed="true" statusBar="true" left-icon="back" @click-left="comeBack" title="消息"></uni-nav-bar>
			...
			<view class="uni-flex uni-row messageList" v-if="item.type==1">
					...
					<view class="uni-flex uni-column right">
						...
						<view class="uni-flex uni-row mesCon">
							...
							<image v-if="actived==1" :src="imageUrl+'alert_icon_dot@xxxhdpi.png'" class="iconStatus"></image>
						</view>
					</view> 
			</view> 
			 <view class="uni-flex uni-row messageList" v-if="item.type==2">
					...
					<view class="uni-flex uni-column right">
						...
						<view class="uni-flex uni-row mesCon" style="">
							...
							<image v-if="readed==1" :src="imageUrl+'alert_icon_dot@xxxhdpi.png'" class="iconStatus"></image>
						</view>
					</view> 
			</view>
...
<script>
	...
	export default {
		...
		//	 console.log(this.messageType)
				 uni.redirectTo({
					url: '/pages/tenant/index/message-detail/message-activity?messageType='+this.messageType
				}); 
			},
			getMessage(){
				uni.request({
